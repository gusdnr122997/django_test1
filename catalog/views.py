...
def index(request):
    ...
    num_books_with_test = Book.objects.filter(title__contains='테스트').count()
    num_genre_with_science = Genre.objects.filter(name__contains='과학').count()
    ...
    context = {
        ...
        'num_books_with_test': num_books_with_test,
        'num_genre_with_science': num_genre_with_science,
